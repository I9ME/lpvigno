...
<div class="Section-subSection Section-subsection--dados Subsection u-marginTop u-positionRelative u-displayFlex u-flexDirectionColumn u-flexSwitchRow">
	<div class="Subsection-content u-positionRelative u-size12of24 u-paddingVertical">
		<div class="Subsection-content-header u-absoluteCenter u-zIndex5">
			<h3 class="Subsection-content-header-title is-animating u-isScrollFade">
				<strong>Tipos de franquia</strong>
			</h3>
		</div>
		<nav class="Subsection-navigation Navigation Navigation--tabs u-positionAbsolute u-zIndex2 u-marginTop--inter u-sizeFull">
		...
		<ul class="Subsection-items Items Items--tabs u-marginTop u-positionRelative">
			...
			<li id="tabContent-1" class="Subsection-items-item Item Item--tab is-animating u-sizeFull u-paddingTop u-positionRelative is-active is-animating">
					...
					<div class="Item-content">
						<header class="Subsection-header">
							<p>Ambiente intimista, com decoração e arquitetura planejada para deixar o ambiente confortável e aconchegante.</p>
						</header>
						<div class="Features u-positionRelative u-displayFlex">
							<ul class="Features-items u-sizeFull u-paddingTop--inter">
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5 u-isScrollFade is-animating--time2">
								...
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5 u-isScrollFade is-animating--time2">
									...
									<span class="Features-items-item-value u-alignRight"><strong>R$ <em>300.000</em>,00</strong></span>
								</li>
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5 u-isScrollFade is-animating--time2">
									...
									<span class="Features-items-item-value u-alignRight"><strong><em>36 - 48</em> meses</strong></span>
								</li>
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5 u-isScrollFade is-animating--time2">
									...
									<span class="Features-items-item-value u-alignRight"><strong>R$ <em>1.</em>200.000,00</strong></span>
								</li>
							</ul>
						</div>
					</div>
			...
			<li id="tabContent-2" class="Subsection-items-item Item Item--tab is-animating u-sizeFull u-paddingTop u-positionRelative is-animating">
				<div class="Item-content">
						<header class="Subsection-header">
							<h4>Atendimento ágil no qual o cliente realiza o pedido no balcão e retira-o quando estiver pronto.</h4>
						</header>
						<div class="Features u-positionRelative u-displayFlex">
							<ul class="Features-items u-sizeFull u-paddingTop--inter">
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-isScrollFade is-animating--time2 u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5">
									<figure class="Features-items-item-figure u-displayInlineBlock FigureIcon--store"></figure>
									<h5 class="Features-items-item-title Section-items-item-title u-paddingLeft--inter--half--px u-flex1">Taxa de Franquia</h5>
								...
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-isScrollFade is-animating--time2 u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5">
									<figure class="Features-items-item-figure u-displayInlineBlock FigureIcon--moedas"></figure>
									<h5 class="Features-items-item-title Section-items-item-title u-paddingLeft--inter--half--px u-flex1">Faturamento Médio</h5>
									<span class="Features-items-item-value u-alignRight"><strong>R$ <em>150.000</em>,00</strong></span>
								</li>
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-isScrollFade is-animating--time2 u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5">
									<figure class="Features-items-item-figure u-displayInlineBlock FigureIcon--report"></figure>
									<h5 class="Features-items-item-title Section-items-item-title u-paddingLeft--inter--half--px u-flex1">Retorno do Investimento</h5>
								...
								<li class="Features-items-item u-displayFlex u-positionRelative u-boxShadow u-paddingHorizontal--vrt--inter--half--px u-marginBottom--inter--half u-isScrollFade is-animating--time2 u-FlexFustifyContentSpaceBetween u-flexAlignItemsCenter u-borderRadius5">
									<figure class="Features-items-item-figure u-displayInlineBlock FigureIcon--money"></figure>
									<h5 class="Features-items-item-title Section-items-item-title u-paddingLeft--inter--half--px u-flex1">Investimento total</h5>
									<span class="Features-items-item-value u-alignRight"><strong>R$ <em>500</em>.000,00</strong></span>
								</li>
							</ul>
						</div>
					</div>
	...
	<div id="tabImage-1" class="Subsection-imageMain u-positionRelative u-size12of24 u-zIndex4 u-lineHeight0 is-active">
		<img class="Subsection-imageMain-src u-maxSize100 is-animating" src="<?php echo get_template_directory_uri() . '/assets/images/subSection-mainImage--pizza' . switch_img_Mobile() . '.png'; ?>" alt="Pizza Vignoli" />
	</div>
	<div id="tabImage-2" data-img-src="<?php echo 'subSection-mainImage--pizza--expresso' . switch_img_Mobile() . '.png'; ?>" class="Subsection-imageMain u-positionRelative u-size12of24 u-lineHeight0 u-zIndex4">
