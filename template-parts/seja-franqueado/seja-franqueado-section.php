			...
			<form class="Form Form--style1 u-size12of24 u-sizeFull">
				<fieldset class="Form-fieldset u-sizeFull u-displayFlex u-flexDirectionColumn">
					<div class="Form-row u-sizeFull u-positionRelative u-displayFlex u-flexDirectionColumn u-flexSwitchRow">
						...
						<input type="email" value="<?php echo $email; ?>" name="email" placeholder="Digite o seu e-mail" class="Form-input Form-input--text Form-input Form-input--email u-sizeFull u-borderRadius5 Form-input Form-input--text u-boxShadow" required="required" />
						</div>
					</div>
					<div class="Form-row u-sizeFull u-positionRelative u-displayFlex u-flexDirectionColumn u-flexSwitchRow">
					...
					<div class="Form-row u-sizeFull u-positionRelative u-displayFlex u-flexDirectionColumn u-flexSwitchRow">
						...
						<div class="Form-coll u-size12of24 u-positionRelative u-marginVertical--inter--half u-marginBottom--inter--half">
							...
							<input type="text" name="firstname" placeholder="Digite a sua cidade" class="Form-input Form-input--text u-sizeFull u-borderRadius5 Form-input Form-input--text u-boxShadow" required="required" />
						</div>
					</div>
					...
					<div class="Form-row u-size8of24 u-marginTop--inter--half u-paddingVertical--inter--half u-overflowHidden u-positionRelative u-displayBlock is-animating u-alignCenter u-sizeFull">
				        <input type="submit" id="_form_13_submit" class="Form-input Form-input--submit Button u-sizeFull u-displayInlineBlock is-animating u-borderRadius5 Button--mediumSize hover" value="CONCLUIR" />
				    </div>
				</fieldset>
			</form>
